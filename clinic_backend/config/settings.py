...
# For development: Allow all localhost ports and Android emulator
...
# Specific origins (add your production domains here)
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@clinic.com')
